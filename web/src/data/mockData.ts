...
export const mockDiet: DietPlan = {
  calories: 2360,
  macro: { carbs: 48, protein: 32, fat: 20 },
  meals: [
    { name: '아침', title: '오트밀 단백질 볼', kcal: 520, items: ['오트밀 60g', '그릭요거트', '블루베리', '삶은 달걀 2개'] },
    { name: '간식', title: '운동 전 에너지', kcal: 260, items: ['바나나', '아메리카노', '프로틴 1스쿱'] },
    { name: '점심', title: '닭가슴살 현미 플레이트', kcal: 710, items: ['현미밥', '닭가슴살 160g', '구운 채소', '김치'] },
    { name: '저녁', title: '연어 회복 식단', kcal: 650, items: ['연어 150g', '고구마', '샐러드', '두부'] }
  ],
  tips: [
