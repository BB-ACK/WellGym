      ...
      <div className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-5xl items-center gap-8 lg:grid-cols-[1fr_27rem]">
        <section className="hidden lg:block">
          <div className="max-w-xl">
            ...
            <h1 className="text-6xl font-black leading-[0.95] tracking-normal">오늘의 운동을 더 선명하게.</h1>
        ...
        <section className="rounded-[1.6rem] bg-white p-5 shadow-soft sm:p-7">
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-ink/45">PWA Fitness Log</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={submit} className="grid gap-4">
            ...
            <button type="submit" className="min-h-12 rounded-xl bg-ink font-black text-white shadow-soft">
